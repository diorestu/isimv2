...
<!-- Mirrored from winsfolio.net/html/ibadah/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 May 2024 05:50:55 GMT -->

<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Ibadah - Home 2</title>
    ...
    <link rel="stylesheet" href="{{ asset('front/assets/css/audioplayer.css') }}">
    <!-- Font Awesome 6 -->
...
<body>
    ...
    <!-- preloader end -->
    <header class="two position-relative" style="background-image: url(assets/img/color-bg.jpg);">
        <div class="container">
            <div class="bottom-bar">
                <div class="two-bar">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="logo">
                            <a href="index-2.html">
                                <img alt="logo" src="front/assets/img/logo.png">
                            </a>
                        </div>
                        <div class="bar-menu">
    ...
    <div class="hero-section two" style="background-image: url(front/assets/img/hero-img-2.jpg);">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="hero-img two">
                        <img src="assets/img/ayat-with-man.png" alt="hero-img">
                        <div class="namaz-timing-schedule">
                            <div class="namaz-timing-date">
                                <h4>December 3, 2024</h4>
                                <span>Isha Jama’ah</span>
                                <h3>7:00 PM</h3>
                                <span>2 Hours 21 Minutes</span>
                            </div>
                            <ul class="namaz-timing-two">
                                <li class="namaz-timing-heading">
                                    <span>Prayer</span>
                                    <span>Begins</span>
                                    <span>Jama’ah</span>
                                </li>
                                <li class="timing-date">
                                    <span>Fajr</span>
                                    <span>6:23 am</span>
                                    <span>6:40 am</span>
                                </li>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="islamic-classes-time">
                        <div class="opening-time">
                            <img src="assets/img/opening-time-1.jpg" alt="img">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="islamic-classes-time">
                        <div class="opening-time">
                            <img src="assets/img/opening-time-2.jpg" alt="img">
                            <div class="opening-time-text">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="islamic-classes-time">
                        <div class="opening-time">
                            <img src="assets/img/opening-time-3.jpg" alt="img">
                            <div class="opening-time-text">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="islamic-classes-time mb-0">
                        <div class="opening-time">
                            <img src="assets/img/opening-time-4.jpg" alt="img">
                            <div class="opening-time-text">
            ...
            <div class="plan-visit">
                <p>Need to know where we are and how to get here?<a href="#">Plan your visit.</a></p>
            </div>
        </div>
    </section>
    <section class="gap welcome-to-ibadat">
        <div class="container">
            <div class="heading two">
                <p>Welcome to the Islamic Center</p>
                <h2>Welcome To Ibadat Islamic Center For Muslims</h2>
            </div>
            <div class="row">
                <div class="col-lg-7">
                    <div class="welcome-to-ibadat-established hoverimg">
                        <h4><span>Established in</span> 1986</h4>
                        <img src="assets/img/ibadat-islamic-1.jpg" alt="img">
                        <img class="to-ibadat-img" src="assets/img/ibadat-islamic-2.jpg" alt="img">
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="islamic-history">
                        <h4>Who We Are</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisc eiusmod tempor incididunt ut labore etedum
                            doad minim veniam, a uis nostr incididunt ut laborci tempor incididunt ut labore cididunt ut
                            labore etedum doad minim .</p>
                        <h4>Who We do</h4>
                        <ul class="list">
                            <li>Peterborough, Developing the community</li>
                            <li>Education, charitable, sports</li>
                            <li>Improving individuals and society</li>
                            <li>Charity Events Schooling Children</li>
                        </ul>
                        <a href="#" class="btn">Read Our History</a>
                    </div>
                </div>
            </div>
            <div class="row pdf-slider owl-carousel owl-theme">
                <div class="item">
                    <div class="surat-download" style="background-image: url(assets/img/color-bg.jpg);">
                        <div class="surat-img">
                            <img src="assets/img/sorat-name-3.png" alt="sorat-name">
                            <div>
                                <h4>Al-Fatihah</h4>
                                <h5>para no 26</h5>
                            </div>
                        ...
                        <div class="pdf-download">
                            <a href="assets/pdf/ibadah.pdf" class="download btn" target="_blank"><i
                ...
                <div class="item">
                    <div class="surat-download" style="background-image: url(assets/img/color-bg.jpg);">
                        <div class="surat-img">
                            <img src="assets/img/sorat-name-2.png" alt="sorat-name">
                            <div>
                                <h4>Al-Mursalat</h4>
                                <h5>para no 29</h5>
                            </div>
                ...
                <div class="item">
                    <div class="surat-download" style="background-image: url(assets/img/color-bg.jpg);">
                        <div class="surat-img">
                            <img src="assets/img/sorat-name-1.png" alt="sorat-name">
                            <div>
                                <h4>An-Naba</h4>
                                <h5>para no 30</h5>
                            </div>
    ...
    <section class="gap our-courses-section" style="background-image: url(assets/img/courses-back.png);">
        <div class="container">
                    ...
                    <div class="scholars">
                        <div class="opening-time hoverimg">
                            ...
                            <div class="opening-time-text">
                                ...
                                <a href="callto:+(00)123-345-11"><svg xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 512 512">
                                        <path
                                            d="M442.77,80.93l.27-.27-9.39-9a256,256,0,0,0-351.8-3.23h0l-.29.28-9.43,8.77.23.23A257,257,0,0,0,0,256V480a32,32,0,0,0,32,32H94.4a59.2,59.2,0,0,0,59.2-59.2v-112a59.2,59.2,0,0,0-59.2-59.2H25.6V256A231.25,231.25,0,0,1,90.48,95.78l6.95,6.95c15.42,15.41,39.38,17.79,56.95,5.66a179.16,179.16,0,0,1,206,2,44.07,44.07,0,0,0,25.82,8.34,45.65,45.65,0,0,0,32.29-13.53L424.66,99A228.56,228.56,0,0,1,486.4,256v25.6H417.6a59.2,59.2,0,0,0-59.2,59.2v112A59.2,59.2,0,0,0,417.6,512H480a32,32,0,0,0,32-32V256A254,254,0,0,0,442.77,80.93ZM76.8,307.2H94.4A33.64,33.64,0,0,1,128,340.8v112a33.64,33.64,0,0,1-33.6,33.6H76.8Zm-25.6,0V486.4H32a6.41,6.41,0,0,1-6.4-6.4V307.2ZM400.41,87.09c-6.81,6.82-17.59,7.91-25.06,2.51a204.77,204.77,0,0,0-235.51-2.3c-7.42,5.13-17.65,4-24.31-2.68l-6.26-6.26a230.51,230.51,0,0,1,297,2.89ZM435.2,486.4H417.6A33.64,33.64,0,0,1,384,452.8v-112a33.64,33.64,0,0,1,33.6-33.6h17.6Zm51.2-6.4a6.41,6.41,0,0,1-6.4,6.4H460.8V307.2h25.6V480Z" />
                                    </svg>+(00) 123-345-11</a>
            ...
            <div class="gap no-bottom heading two">
                <p>Quran Tilawat</p>
                <h2>Recent Sermon</h2>
            </div>
            <div class="audio-ayat owl-carousel">
                ...
                <div class="item col-lg-11">
                    <div class="wrapper">
                        ...
                        <h5>(Abd-ur-Rahman)</h5>
                        <audio preload="auto" controls>
                            <source src="assets/audio/surah-kausar.mp3">
                        </audio>
                    </div>
                </div>
                <div class="item col-lg-11">
    ...
    <section class="gap gallery no-bottom" style="background-image: url(assets/img/gallery-bg.jpg);">
        <div class="container">
            <div class="slider-ayat two owl-carousel">
                <div class="ayat item">
                    <img src="assets/img/ayat-two.png" alt="ayat">
            ...
            <ul class="image-gallery">
                <li>
                    <a href="assets/img/blog-detail-img-1.jpg" data-fancybox="gallery">
                        <figure><img alt="girl" src="assets/img/blog-detail-img-1.jpg"></figure>
                    </a>
                </li>
                <li>
                    <a href="assets/img/blog-detail-img-2.jpg" data-fancybox="gallery">
                        <figure><img alt="girl" src="assets/img/blog-detail-img-2.jpg"></figure>
                    </a>
                </li>
                <li>
                    <a href="assets/img/blog-detail-img-3.jpg" data-fancybox="gallery">
                        <figure><img alt="girl" src="assets/img/blog-detail-img-3.jpg"></figure>
                    </a>
                </li>
                <li>
                    <a href="assets/img/blog-detail-img-4.jpg" data-fancybox="gallery">
                        <figure><img alt="girl" src="assets/img/blog-detail-img-4.jpg"></figure>
                    </a>
                </li>
                <li>
                    <a href="assets/img/blog-detail-img-5.jpg" data-fancybox="gallery">
                        <figure><img alt="girl" src="assets/img/blog-detail-img-5.jpg"></figure>
                    </a>
                </li>
                <li>
                    <a href="assets/img/blog-img-3.jpg" data-fancybox="gallery">
                        <figure><img alt="girl" src="assets/img/blog-img-3.jpg"></figure>
                    </a>
                </li>
            </ul>
        </div>
    ...
    <section class="gap no-top">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="travel-package two">
                        <div class="package-reat">
                            <div>
                                <h4>Umra Package</h4>
                                <h5>$1400<span>/10 days</span></h5>
                            </div>
                            <i>
                                <svg height="511pt" viewBox="0 0 511.99931 511" width="511pt"
                                    xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="travel-package-list" style="background-image:url(assets/img/color-bg.jpg);">
                            <ul>
                                <li><i class="fa-regular fa-circle-check"></i>Flights and Visa Included</li>
                                <li><i class="fa-regular fa-circle-check"></i>2 Nights Makkah</li>
                                <li><i class="fa-regular fa-circle-check"></i>Medical Insurance</li>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="travel-package mb-0">
                        <div class="package-reat">
                            <div>
                                <h4>Hajj Package</h4>
                                <h5>$2690<span>/18 days</span></h5>
                            </div>
                            <i>
                                <svg height="511pt" viewBox="0 0 511.99931 511" width="511pt"
                                    xmlns="http://www.w3.org/2000/svg">
    ...
    <section class="gap program" style="background-image: url(assets/img/program.png);">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="program-img">
                        <ul>
                            <li class="hoverimg">
                                <figure><img src="assets/img/program-img-1.jpg" alt="img"></figure>
                            </li>
                            <li class="hoverimg">
                                <figure><img src="assets/img/program-img-2.jpg" alt="img"></figure>
                            </li>
                            <li class="hoverimg">
                                <figure><img src="assets/img/program-img-3.jpg" alt="img"></figure>
                            </li>
                            <li class="hoverimg">
                                <figure><img src="assets/img/program-img-4.jpg" alt="img"></figure>
                            </li>
                        </ul>
                        <div class="program-time">
                            <i class="fa-regular fa-clock"></i>
                            <h5>26th Jumada-Al-Thani, 1445 Mon, <span>8th Jan, 2024 - London, UK</span></h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    ...
                    <div class="courses-two">
                        ...
                        <div>
                            ...
                            <div class="scholar-two">
                                <img src="assets/img/scholar.jpg" alt="img">
                                <h4>Habib Al Noor <span>Arabic scholar</span></h4>
                            </div>
                        </div>
                        <h6>$16.00</h6>
                    </div>
    ...
    <section class="gap no-bottom">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-two hoverimg mb-0">
                        <figure>
    ...
    <section class="masjid" style="background-image: url(assets/img/masjid.png);">
        <div class="container">
            <div class="row">
                <div class="masjid-text">
                    <h3>Help Us Rebuild the <span>House of Allah</span></h3>
                    <p>Your donations will help our community rebuild the House of Allah.</p>
                    <a href="#" class="btn">Donate Now</a>
                </div>
            </div>
        </div>
    </section>
    <footer class="two" style="background-image: url(assets/img/footer-img-1.jpg);">
        <div class="container">
            <div class="row Information pb-0">
                <div class="col-lg-4 col-md-6">
                    <div class="widget-title">
                        <h3>Information</h3>
                        <h4>309-313 Mill Rd, Cambridge, CB1 3DF,United State</h4>
                        <h5><a href="callto:254(98)2156213">+254 (98) 2156 213</a></h5>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="widget-title">
                        ...
                        <ul>
                            ...
                            <li><i class="fa-solid fa-angle-right"></i><a href="#">Quran Hifz Classes</a></li>
                            <li class="pb-0"><i class="fa-solid fa-angle-right"></i><a href="#">Urgent
                                    Donation</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="learn-quran" style="background-image: url(assets/img/color-bg.jpg);">
                        <h4>Learn Quran With Us</h4>
                        <p>Easily admission your self with us</p>
                        <form>
    ...
    <script src="{{ asset('front/assets/js/circle-progres.js') }}"></script>
    <!-- fancybox -->
    <script src="{{ asset('front/assets/js/audioplayer.js') }}"></script>
    <script>
        $(function() {
            $('audio').audioPlayer();
        });
