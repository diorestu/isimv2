        ...
        <div class="auth-wrapper">
            <div class="auth-sidecontent">
                <div class="auth-sidefooter">
                    <img src="{{ asset('logo_muhajirin.png') }}" class="img-brand img-fluid" alt="images"
                        width="75%" />
                    <hr class="mb-3 mt-4" />
                    <div class="row">
                        <div class="col my-1">
                            <p class="m-0">Made with ♥ by <a href="javascript:void(0)">
                                    Muhajirin IT Support</a></p>
                        </div>
            ...
            <form class="auth-form" action="{{ route('login.post') }}" method="post">
                ...
                <div class="card my-5 mx-3">
                    <div class="card-body">
                        ...
                        <h4 class="f-w-500 mb-1">Login ke ISIM</h4>
                        <p class="mb-3">Lupa akun Anda? <a href="../pages/register-v2.html"
                                class="link-primary ms-1">Hubungi Admin</a></p>
                        <div class="mb-3">
                            <input type="text"
                                class="form-control @error('username')
                            is-invalid
                            @enderror"
                                name="username" id="floatingInputUsername" placeholder="Nama Pengguna"
                        ...
                        <div class="mb-3">
                            ...
                            is-invalid
                            @enderror"
                                id="floatingInputPassword" placeholder="Kata Sandi" autocomplete="one-time-code">
                        </div>
                        ...
                        <div class="d-grid mt-4">
                            <button type="submit" class="btn btn-secondary shadow">Masuk</button>
                        </div>
                    </div>
                </div>
            </form>
