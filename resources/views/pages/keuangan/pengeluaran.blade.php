...
@section('content')
    <x-page-header title="Tambah Pengeluaran" />
    <x-card title="">
        ...
        <hr>
        <form action="{{ route('keuangan.input.pengeluaran') }}" method="post" id="myForm">
            @csrf
            @method('POST')
            <div class="row g-4">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <x-input type='number' name="kredit" placeholder="Nominal Pengeluaran">Nominal Pengeluaran</x-input>
                </div>
                <div class="col-12">
                    <div class="form-floating">
